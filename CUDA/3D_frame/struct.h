...
struct fcndata
{
	...
	double *d_nmlNowMat;       // elmNum * DIMNUM
	double *d_nmlNxtMat;       // elmNum * DIMNUM
	...
	// for deformation
	double *d_ynkActMat;       // lmkNum * timeNum
	double *d_exYStk;          // lmkNum * DIMNUM * (timeNum - 1)
	double *d_elYStk;          // lmkNum * DIMNUM * (timeNum - 1)
