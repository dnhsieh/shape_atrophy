                                    ...
                                    int *d_elmVtxMat, int elmNum)
{
	...
	if ( elmIdx < elmNum )
	{
		...
		d_rpdElmMat[             elmIdx] = (2.0 * f0Val +       f1Val +       f2Val) * absDetQ / 24.0;
		d_rpdElmMat[    elmNum + elmIdx] = (      f0Val + 2.0 * f1Val +       f2Val) * absDetQ / 24.0;
		d_rpdElmMat[2 * elmNum + elmIdx] = (      f0Val +       f1Val + 2.0 * f2Val) * absDetQ / 24.0;
	}
